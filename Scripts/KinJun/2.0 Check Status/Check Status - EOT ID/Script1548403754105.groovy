...
WebUI.callTestCase(findTestCase('KinJun/While Loop/While Loop - EOT ID'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('KinJun/While Loop/While Loop - EOT Username'), [:], FailureHandling.STOP_ON_FAILURE)
