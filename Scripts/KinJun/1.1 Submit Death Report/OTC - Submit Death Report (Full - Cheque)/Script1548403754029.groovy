...
WebUI.callTestCase(findTestCase('KinJun/Common Activity - Setter/Setter EOT'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('KinJun/2.0 Check Status/Check Status - EOT ID'), [:], FailureHandling.STOP_ON_FAILURE)
