...
WebUI.callTestCase(findTestCase('All TC/Kenny/Getter IC'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Kenny/OB Login/Email Address'), GlobalVariable.IC)

WebUI.delay(3)

WebUI.callTestCase(findTestCase('All TC/Kenny/Getter Password'), [:], FailureHandling.STOP_ON_FAILURE)
