...
WebUI.callTestCase(findTestCase('All TC/Arranged/3. Unit/ES/SEIO Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('All TC/Arranged/3. Unit/ES/While Loop 1'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.callTestCase(findTestCase('All TC/Arranged/3. Unit/ES/While Loop 2'), [:], FailureHandling.STOP_ON_FAILURE)
