...
WebUI.callTestCase(findTestCase('All TC/Arranged/0. Full Flow/Approve Claim - RIA (EFT)'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('All TC/Arranged/2. Segment/2.6 Disbursement/DS - EFT/DS - Pending Claim (EFT)'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('All TC/Arranged/2. Segment/2.6 Disbursement/DS - EFT/DS - Reject Case (EFT Approved Claim)'), 
