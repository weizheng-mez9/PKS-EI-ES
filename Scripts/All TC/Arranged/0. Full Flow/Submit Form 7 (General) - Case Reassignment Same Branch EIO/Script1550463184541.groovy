...
WebUI.callTestCase(findTestCase('All TC/Arranged/2. Segment/2.7 Case Reassignment/Case_Reassignment_Same Branch/Case reassignment_EIO to EIO_Same Branch'), 
    [:], FailureHandling.STOP_ON_FAILURE)
