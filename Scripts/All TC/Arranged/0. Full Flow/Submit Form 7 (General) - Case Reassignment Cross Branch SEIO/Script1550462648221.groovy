...
WebUI.callTestCase(findTestCase('All TC/Arranged/2. Segment/2.7 Case Reassignment/Case_Reassignment_Cross Branch/Case reassigment_SEIO to SEIO to SEIO_Cross Branch'), 
    [:], FailureHandling.STOP_ON_FAILURE)
