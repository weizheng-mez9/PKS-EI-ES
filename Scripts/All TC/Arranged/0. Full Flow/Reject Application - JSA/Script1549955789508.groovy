...
WebUI.callTestCase(findTestCase('All TC/Arranged/2. Compiled/2.3 JSA Application/EIO Internal Login - JSA Application - Reject'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('All TC/Arranged/2. Compiled/2.3 JSA Application/SEIO Internal Login - JSA Application - Reject'), 
    [:], FailureHandling.STOP_ON_FAILURE)
