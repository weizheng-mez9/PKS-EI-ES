...
WebUI.callTestCase(findTestCase('All TC/Arranged/2. Segment/2.3 JSA Application/SEIO Internal Login - JSA Application - Approve'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('All TC/Arranged/2. Segment/OB Fills UJP Info'), [:], FailureHandling.STOP_ON_FAILURE)
