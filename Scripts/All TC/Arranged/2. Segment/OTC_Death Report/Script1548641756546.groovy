...
WebUI.setText(findTestObject('KeatMun/OTC_Death Report/Page_PERKESO/5. IP_IC'), GlobalVariable.IC)
...
WebUI.sendKeys(findTestObject('KeatMun/OTC_Death Report/Page_PERKESO/11.--Sila Pilih--_singleFile'), GlobalVariable.TextFilePathCommon + 
    '\\UploadDoc.txt')
