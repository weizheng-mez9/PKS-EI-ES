...
WebUI.click(findTestObject('KinJun/3.0 JSA Application/SEIO Internal Login - JSA Application - Reject/Page_PERKESO/Span reject reason'))

WebUI.delay(5)

WebUI.click(findTestObject('KinJun/3.0 JSA Application/SEIO Internal Login - JSA Application - Reject/Page_PERKESO/DD reject reason'))
