...
while (boolVerify.equals(true)) {
    strXpathA = (('(id("mytable")/tbody[1]/tr[' + counterF) + ']/td[2])')
...
WebUI.callTestCase(findTestCase('All TC/Arranged/1. Common/1.2 Setter/Setter Approval ID'), [:], FailureHandling.STOP_ON_FAILURE)
