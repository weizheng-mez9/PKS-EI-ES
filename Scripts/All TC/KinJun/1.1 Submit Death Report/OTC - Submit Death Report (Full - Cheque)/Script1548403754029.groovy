...
WebUI.callTestCase(findTestCase('All TC/KinJun/Common Activity - Setter/Setter EOT'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('All TC/KinJun/2.0 Check Status/Check Status - EOT ID'), [:], FailureHandling.STOP_ON_FAILURE)
