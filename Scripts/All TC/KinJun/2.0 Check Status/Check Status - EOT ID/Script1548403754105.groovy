...
WebUI.callTestCase(findTestCase('All TC/KinJun/While Loop/While Loop - EOT ID'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('All TC/KinJun/While Loop/While Loop - EOT Username'), [:], FailureHandling.STOP_ON_FAILURE)
