...
WebUI.click(findTestObject('ZhiHao/Case_Reassignment_Same Branch/Case reassigment_SEIO to SEIO_Same Branch/Page_PERKESO/click_SENARAI KES'))
...
WebUI.click(findTestObject('ZhiHao/Case_Reassignment_Same Branch/Case reassigment_SEIO to SEIO_Same Branch/Page_PERKESO/click_button_Cari'))

WebUI.delay(2)

WebUI.click(findTestObject('ZhiHao/Case_Reassignment_Same Branch/Case reassigment_SEIO to SEIO_Same Branch/Page_PERKESO/click_button_Tindakan'))

WebUI.delay(2)

WebUI.click(findTestObject('ZhiHao/Case_Reassignment_Same Branch/Case reassigment_SEIO to SEIO_Same Branch/Page_PERKESO/click_Menugas Semula'))
...
def StrB = WebUI.getText(findTestObject('ZhiHao/Case_Reassignment_Same Branch/Case reassigment_SEIO to SEIO_Same Branch/Page_PERKESO/Get Text_Nama Pegawai'))

System.out.println(StrB)

if (!(StrA == StrB)) {
    WebUI.click(findTestObject('ZhiHao/Case_Reassignment_Same Branch/Case reassigment_SEIO to SEIO_Same Branch/Page_PERKESO/input_Jumlah Kes_staffRadio_1'))
} else {
