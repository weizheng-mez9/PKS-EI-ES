...
//need Looper here
WebUI.callTestCase(findTestCase('All TC/Unarranged/YongJun/Common/GetterCaseID'), [:], FailureHandling.STOP_ON_FAILURE)
...
while (boolVerify.equals(true)) {
    strXpathA = (('(id("gfpiTable")/tbody[1]/tr[@class="odd"]/td[2])[' + counterA) + ']')

    strXpathB = (('(id("gfpiTable")/tbody[1]/tr[@class="even"]/td[2])[' + counterB) + ']')

    strXpathCheckboxA = (('(id("gfpiTable")/tbody[1]/tr[@class="odd"]/td[1]/input[@type="checkbox"])[' + counterA) + ']')

    strXpathCheckboxB = (('(id("gfpiTable")/tbody[1]/tr[@class="even"]/td[1]/input[@type="checkbox"])[' + counterB) + ']')
