...
WebUI.click(findTestObject('KinJun/1.1 Submit Death Report/OTC - Submit Death Report (Full - Cheque)/Page_PERKESO/Upload bank'))
...
WebUI.click(findTestObject('KinJun/1.1 Submit Death Report/OTC - Submit Death Report (Full - Cheque)/Page_PERKESO/Btn Bank'))
...
WebUI.callTestCase(findTestCase('All TC/Unarranged/KinJun/Common Activity - Setter/Setter EOT'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('All TC/Unarranged/KinJun/2.0 Check Status/Check Status - EOT ID'), [:], FailureHandling.STOP_ON_FAILURE)
