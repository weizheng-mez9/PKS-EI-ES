...
WebUI.setText(findTestObject('KinJun/4.1 DA Claim/SEIO Internal Login - DA Claim - Approve/Page_PERKESO/Input username'), 
...
WebUI.setText(findTestObject('KinJun/4.1 DA Claim/SEIO Internal Login - DA Claim - Approve/Page_PERKESO/Input approvalID'), 
    GlobalVariable.EOT)
...
WebUI.setText(findTestObject('KinJun/4.1 DA Claim/SEIO Internal Login - DA Claim - Approve/Page_PERKESO/Input IC'), 
    GlobalVariable.IC)
