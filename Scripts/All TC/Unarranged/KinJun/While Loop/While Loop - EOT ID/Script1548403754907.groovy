...
while (boolVerify.equals(true)) {
    strXpathA = (('(id("dependentApplicationTable")/tbody[1]/tr[@class="odd"]/td[1])[' + counterA) + ']')

    strXpathB = (('(id("dependentApplicationTable")/tbody[1]/tr[@class="even"]/td[1])[' + counterB) + ']')
