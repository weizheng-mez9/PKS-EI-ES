...
not_run: WebUI.callTestCase(findTestCase('All TC/Unarranged/KinJun/5.0 ERA process/1. ESO - Internal Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('All TC/Unarranged/KinJun/5.0 ERA process/3. ESO - Fill ERA Form'), [:], FailureHandling.STOP_ON_FAILURE)
