...
WebUI.callTestCase(findTestCase('All TC/Unarranged/KinJun/While Loop/While Loop - Approval ID'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.callTestCase(findTestCase('All TC/Unarranged/KinJun/While Loop/While Loop - Claim Username'), [:], FailureHandling.STOP_ON_FAILURE)
