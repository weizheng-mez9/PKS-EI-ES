...
WebUI.callTestCase(findTestCase('YongJun/Common/Email Finder'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('YongJun/Common/DS3 Case Finder'), [:], FailureHandling.STOP_ON_FAILURE)
