...
WebUI.callTestCase(findTestCase('Yuki/Common/Getter IC'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Yuki/Common/Setter Approval ID'), [:], FailureHandling.STOP_ON_FAILURE)
