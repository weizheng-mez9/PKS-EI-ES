...
WebUI.callTestCase(findTestCase('Yuki/Approve ERA/SEIO Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Yuki/Common/Getter Approval ID'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Yuki/Approve ERA/While Loop 1'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.delay(2)

WebUI.callTestCase(findTestCase('Yuki/Approve ERA/While Loop 2'), [:], FailureHandling.STOP_ON_FAILURE)
